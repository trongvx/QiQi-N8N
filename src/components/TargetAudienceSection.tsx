        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          <div className="lg:w-1/3 text-center lg:text-left">
            ...
            >
              ...
              <h2 className="font-heading text-4xl md:text-6xl font-bold text-white mb-8 tracking-tight leading-none">
                KHÓA HỌC <br /> <span className="text-cyan-400 uppercase">DÀNH CHO AI?</span>
              </h2>
          ...
          <div className="lg:w-2/3 grid sm:grid-cols-2 gap-8 w-full">
            {audiences.map((item, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-white uppercase tracking-tight group-hover:text-cyan-400 transition-colors">
                    {item.title}
                </h3>
